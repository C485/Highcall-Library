...
typedef BOOLEAN(CALLBACK* HC_PROCESS_CALLBACK_EVENT)(HC_PROCESS_INFORMATION, LPARAM);
typedef BOOLEAN(CALLBACK* HC_MODULE_CALLBACK_EVENT)(HC_MODULE_INFORMATION, LPARAM);
