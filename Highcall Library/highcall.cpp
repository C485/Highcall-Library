...
HMODULE NTDLL = HcGetModuleHandle(L"ntdll.dll");
...
#pragma region HighCall API Trampoline Define

TrampolineJump tjGetWindowThreadProcessId = HcGetProcedureAddress(USER32, "GetWindowThreadProcessId") + 5;
static __declspec(naked) BOOL WINAPI HcWindowThreadProcessId(_In_ HWND hWnd, _Out_opt_ LPDWORD lpdwProcessId)
{
	__asm
	{
		mov    edi, edi
...
static __declspec(naked) BOOL WINAPI HcGetCursorPos(
...
static __declspec(naked) BOOL WINAPI HcPostMessageA(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	__asm
	{
		mov    edi, edi
...
static __declspec(naked) BOOL WINAPI HcPostMessageW(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	__asm
	{
		mov    edi, edi
...
static __declspec(naked) BOOL WINAPI HcSendMessageA(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	__asm
	{
		mov    edi, edi
...
static __declspec(naked) BOOL WINAPI HcSendMessageW(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	__asm
	{
		mov    edi, edi
...
static __declspec(naked) HANDLE WINAPI HcCreateRemoteThread(
...
#pragma region HighCall API Syscall Define

#pragma region HighCall Statics
...
static __declspec(naked) NTSTATUS NTAPI HcQueryInformationToken(_In_ HANDLE TokenHandle,
...
static __declspec(naked) NTSTATUS NTAPI HcOpenProcessToken(_In_ HANDLE hProcess,
...
static __declspec(naked) NTSTATUS NTAPI HcResumeProcess(IN HANDLE ProcessHandle)
{
	__asm
	{
...
static __declspec(naked) NTSTATUS NTAPI HcSuspendProcess(IN HANDLE ProcessHandle)
{
	__asm
	{
...
static __declspec(naked) NTSTATUS NTAPI HcAllocateVirtualMemory(IN HANDLE hProcess,
...
static __declspec(naked) NTSTATUS NTAPI HcFreeVirtualMemory(IN HANDLE hProcess,
	IN PVOID* UBaseAddress,
...
static __declspec(naked) NTSTATUS NTAPI HcResumeThread(IN HANDLE ThreadHandle,
...
static __declspec(naked) NTSTATUS NTAPI HcQueryInformationThread(IN HANDLE ThreadHandle,
...
static __declspec(naked) NTSTATUS NTAPI HcCreateThread(OUT PHANDLE ThreadHandle,
...
static __declspec(naked) NTSTATUS NTAPI HcFlushInstructionCache(IN HANDLE ProcessHandle,
...
static __declspec(naked) NTSTATUS NTAPI HcOpenProcess
(
...
static __declspec(naked) NTSTATUS NTAPI HcProtectVirtualMemory(IN HANDLE ProcessHandle,
...
static __declspec(naked) NTSTATUS NTAPI HcReadVirtualMemory(HANDLE ProcessHandle, PVOID BaseAddress, PVOID Buffer, SIZE_T BufferSize, PSIZE_T NumberOfBytesRead)
{
	__asm
	{
...
static __declspec(naked) NTSTATUS NTAPI HcWriteVirtualMemory(HANDLE ProcessHandle, PVOID BaseAddress, CONST VOID *Buffer, SIZE_T BufferSize, PSIZE_T NumberOfBytesWritten)
{
	__asm
	{
...
static __declspec(naked) NTSTATUS NTAPI HcQueryInformationProcess(
...
static __declspec(naked) NTSTATUS NTAPI HcQuerySystemInformation(
...
static __declspec(naked) NTSTATUS NTAPI HcClose(HANDLE hObject)
{
	__asm
	{
		mov eax, [sciClose]
...
#pragma region HighCall API Import Define

DWORD dwRtlGetVersion = HcGetProcedureAddress(NTDLL, "RtlGetVersion");
static __declspec(naked) NTSTATUS NTAPI RtlGetVersion(_Out_ PRTL_OSVERSIONINFOW lpInformation)
{
	__asm
	{
		jmp [dwRtlGetVersion]
...
DWORD dwRtlEqualUnicodeString = HcGetProcedureAddress(NTDLL, "RtlEqualUnicodeString");
static __declspec(naked) BOOLEAN NTAPI RtlEqualUnicodeString(
	...
	__asm
	{
		jmp[dwRtlEqualUnicodeString]
	}
}

DWORD dwRtlInitUnicodeString = HcGetProcedureAddress(NTDLL, "RtlInitUnicodeString");
static __declspec(naked) VOID NTAPI RtlInitUnicodeString(
	_Out_    PUNICODE_STRING DestinationString,
	_In_opt_ PCWSTR          SourceString
) {
	__asm
	{
		jmp[dwRtlInitUnicodeString]
	}
}

DWORD dwLdrLoadDll = HcGetProcedureAddress(NTDLL, "LdrLoadDll");
static __declspec(naked) NTSTATUS NTAPI LdrLoadDll(IN PWCHAR PathToFile OPTIONAL,
...
DWORD dwRtlAllocateActivationContextStack = HcGetProcedureAddress(NTDLL, "RtlAllocateActivationContextStack");
static __declspec(naked) NTSTATUS NTAPI RtlAllocateActivationContextStack(IN PACTIVATION_CONTEXT_STACK *Stack)
{
	__asm
	{
		jmp[dwRtlAllocateActivationContextStack]
	}
}

DWORD dwRtlQueryInformationActivationContext = HcGetProcedureAddress(NTDLL, "RtlQueryInformationActivationContext");
static __declspec(naked) NTSTATUS NTAPI RtlQueryInformationActivationContext(ULONG flags, HANDLE handle, PVOID subinst,
	ULONG Class, PVOID buffer,
	SIZE_T bufsize, SIZE_T *retlen)
{
	__asm
	{
		jmp[dwRtlQueryInformationActivationContext]
	}
}

DWORD dwRtlFreeActivationContextStack = HcGetProcedureAddress(NTDLL, "RtlFreeActivationContextStack");
static __declspec(naked) VOID NTAPI RtlFreeActivationContextStack(IN PACTIVATION_CONTEXT_STACK Stack)
{
	__asm
	{
		jmp[dwRtlFreeActivationContextStack]
	}
}

DWORD dwRtlFreeThreadActivationContextStack = HcGetProcedureAddress(NTDLL, "RtlFreeThreadActivationContextStack");
static __declspec(naked) VOID NTAPI RtlFreeThreadActivationContextStack(VOID)
{
	__asm
	{
		jmp[dwRtlFreeThreadActivationContextStack]
	}
}

DWORD dwRtlActivateActivationContextEx = HcGetProcedureAddress(NTDLL, "RtlActivateActivationContextEx");
static __declspec(naked) NTSTATUS NTAPI RtlActivateActivationContextEx(ULONG flags, PTEB tebAddress, HANDLE handle, PULONG_PTR cookie)
{
	__asm
	{
		jmp[dwRtlActivateActivationContextEx]
	}
}

#pragma endregion

#pragma region HighCall API String
...
#pragma region Highcall Internal Memory Handling
...
#pragma region HighCall Pathing
...
#pragma region HighCall Initialization

/* Might need to turn off optimization */

/* Just for some initialization... */
typedef BYTE Unused;
